...
현대 웹 개발에서는 Spring MVC 패턴이 당연하게 사용됩니다.  
하지만 **90년대 후반~00년대 초반 선배 개발자들은 어떻게 개발했을까요?**

이 미션은 **MVC 패턴이 없던 시절로 돌아가서**, 그 시절의 불편함을 직접 체험한 뒤  
**점진적으로 MVC 패턴으로 리팩토링**하면서 *왜 MVC가 필요한지*를 온몸으로 느끼는 것이 목표입니다.
